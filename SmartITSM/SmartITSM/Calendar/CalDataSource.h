...
/*
 *    CalDataSource protocol
 *    ----------------------
 *
 *  The CalDataSource's protocol has 2 responsibilities:
 *    1) Vend UITableViewCells as part of the UITableViewDataSource protocol.
 *    2) Instruct the CalViewController which days should be marked with a dot.
 *
 ...
 *        as well as any time that Cal wants to clear the table view
...
@protocol CalDataSourceCallbacks;

@protocol CalDataSource <NSObject, UITableViewDataSource>
...
@protocol CalDataSourceCallbacks <NSObject>
- (void)loadedDataSource:(id<CalDataSource>)dataSource;
@end
 ...
 *    -------------------
 *
 *  A null implementation of the CalDataSource protocol.
 *
 */

@interface SimpleCalDataSource : NSObject <CalDataSource>
{
}
